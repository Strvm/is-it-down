...
- `IS_IT_DOWN_API_CACHE_MEMORY_MAX_ENTRIES` (default: `256`)
- `IS_IT_DOWN_API_CACHE_MEMORY_MAX_BYTES` (default: `16777216`)
- `IS_IT_DOWN_API_CACHE_MEMORY_MAX_PAYLOAD_BYTES` (default: `65536`)
