"""Provide functionality for `is_it_down.checkers.services.postman`."""
...
class PostmanStatusPageCheck(BaseCheck):
    """Represent `PostmanStatusPageCheck`."""

    check_key = "postman_status_page"
    endpoint_key = "https://status.postman.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.4
...
class PostmanApiAuthCheck(BaseCheck):
    """Represent `PostmanApiAuthCheck`."""

    check_key = "postman_api_auth"
    endpoint_key = "https://api.getpostman.com/me"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class PostmanHomepageCheck(BaseCheck):
    """Represent `PostmanHomepageCheck`."""

    check_key = "postman_homepage"
    endpoint_key = "https://www.postman.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class PostmanServiceChecker(BaseServiceChecker):
    """Represent `PostmanServiceChecker`."""

    service_key = "postman"
    logo_url = "https://cdn.simpleicons.org/postman"
    official_uptime = "https://status.postman.com/"
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            PostmanStatusPageCheck(),
            PostmanApiAuthCheck(),
            PostmanHomepageCheck(),
        ]
