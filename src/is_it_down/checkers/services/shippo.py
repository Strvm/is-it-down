"""Provide functionality for `is_it_down.checkers.services.shippo`."""
...
class ShippoStatusCheck(BaseCheck):
    """Represent `ShippoStatusCheck`."""

    check_key = "shippo_status"
    endpoint_key = "https://status.goshippo.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class ShippoSummaryCheck(BaseCheck):
    """Represent `ShippoSummaryCheck`."""

    check_key = "shippo_summary"
    endpoint_key = "https://status.goshippo.com/api/v2/summary.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.2
...
class ShippoComponentsCheck(BaseCheck):
    """Represent `ShippoComponentsCheck`."""

    check_key = "shippo_components"
    endpoint_key = "https://status.goshippo.com/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ShippoHomepageCheck(BaseCheck):
    """Represent `ShippoHomepageCheck`."""

    check_key = "shippo_homepage"
    endpoint_key = "https://goshippo.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ShippoRobotsCheck(BaseCheck):
    """Represent `ShippoRobotsCheck`."""

    check_key = "shippo_robots"
    endpoint_key = "https://goshippo.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class ShippoServiceChecker(BaseServiceChecker):
