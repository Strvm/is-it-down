"""Provide functionality for `is_it_down.checkers.services.splunk`."""
...
class SplunkStatusCheck(BaseCheck):
    """Represent `SplunkStatusCheck`."""

    check_key = "splunk_status"
    endpoint_key = "https://status.splunk.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class SplunkSummaryCheck(BaseCheck):
    """Represent `SplunkSummaryCheck`."""

    check_key = "splunk_summary"
    endpoint_key = "https://status.splunk.com/api/v2/summary.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.2
...
class SplunkComponentsCheck(BaseCheck):
    """Represent `SplunkComponentsCheck`."""

    check_key = "splunk_components"
    endpoint_key = "https://status.splunk.com/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class SplunkHomepageCheck(BaseCheck):
    """Represent `SplunkHomepageCheck`."""

    check_key = "splunk_homepage"
    endpoint_key = "https://www.splunk.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class SplunkRobotsCheck(BaseCheck):
    """Represent `SplunkRobotsCheck`."""

    check_key = "splunk_robots"
    endpoint_key = "https://www.splunk.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class SplunkServiceChecker(BaseServiceChecker):
    """Represent `SplunkServiceChecker`."""

    service_key = "splunk"
    logo_url = "https://cdn.simpleicons.org/splunk"
    official_uptime = "https://status.splunk.com/"
