"""Provide functionality for `is_it_down.checkers.services.proton`."""
...
class ProtonStatusCheck(BaseCheck):
    """Represent `ProtonStatusCheck`."""

    check_key = "proton_status"
    endpoint_key = "https://status.proton.me/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class ProtonSummaryCheck(BaseCheck):
    """Represent `ProtonSummaryCheck`."""

    check_key = "proton_summary"
    endpoint_key = "https://status.proton.me/api/v2/summary.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.2
...
class ProtonComponentsCheck(BaseCheck):
    """Represent `ProtonComponentsCheck`."""

    check_key = "proton_components"
    endpoint_key = "https://status.proton.me/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ProtonHomepageCheck(BaseCheck):
    """Represent `ProtonHomepageCheck`."""

    check_key = "proton_homepage"
    endpoint_key = "https://proton.me/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ProtonRobotsCheck(BaseCheck):
    """Represent `ProtonRobotsCheck`."""

    check_key = "proton_robots"
    endpoint_key = "https://proton.me/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class ProtonServiceChecker(BaseServiceChecker):
    """Represent `ProtonServiceChecker`."""

    service_key = "proton"
    logo_url = "https://cdn.simpleicons.org/proton"
    official_uptime = "https://status.proton.me/"
