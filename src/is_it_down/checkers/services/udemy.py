"""Provide functionality for `is_it_down.checkers.services.udemy`."""
...
class UdemyStatusCheck(BaseCheck):
    """Represent `UdemyStatusCheck`."""

    check_key = "udemy_status"
    endpoint_key = "https://status.udemy.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class UdemySummaryCheck(BaseCheck):
    """Represent `UdemySummaryCheck`."""

    check_key = "udemy_summary"
    endpoint_key = "https://status.udemy.com/api/v2/summary.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.2
...
class UdemyComponentsCheck(BaseCheck):
    """Represent `UdemyComponentsCheck`."""

    check_key = "udemy_components"
    endpoint_key = "https://status.udemy.com/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class UdemyHomepageCheck(BaseCheck):
    """Represent `UdemyHomepageCheck`."""

    check_key = "udemy_homepage"
    endpoint_key = "https://www.udemy.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class UdemyRobotsCheck(BaseCheck):
    """Represent `UdemyRobotsCheck`."""

    check_key = "udemy_robots"
    endpoint_key = "https://www.udemy.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class UdemyServiceChecker(BaseServiceChecker):
    """Represent `UdemyServiceChecker`."""

    service_key = "udemy"
    logo_url = "https://cdn.simpleicons.org/udemy"
    official_uptime = "https://status.udemy.com/"
