"""Provide functionality for `is_it_down.checkers.services.zoominfo`."""
...
class ZoominfoStatusCheck(BaseCheck):
    """Represent `ZoominfoStatusCheck`."""

    check_key = "zoominfo_status"
    endpoint_key = "https://status.zoominfo.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class ZoominfoSummaryCheck(BaseCheck):
    """Represent `ZoominfoSummaryCheck`."""

    check_key = "zoominfo_summary"
    endpoint_key = "https://status.zoominfo.com/api/v2/summary.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.2
...
class ZoominfoComponentsCheck(BaseCheck):
    """Represent `ZoominfoComponentsCheck`."""

    check_key = "zoominfo_components"
    endpoint_key = "https://status.zoominfo.com/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ZoominfoHomepageCheck(BaseCheck):
    """Represent `ZoominfoHomepageCheck`."""

    check_key = "zoominfo_homepage"
    endpoint_key = "https://www.zoominfo.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ZoominfoRobotsCheck(BaseCheck):
    """Represent `ZoominfoRobotsCheck`."""

    check_key = "zoominfo_robots"
    endpoint_key = "https://www.zoominfo.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class ZoominfoServiceChecker(BaseServiceChecker):
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        return [
            ZoominfoStatusCheck(),
            ZoominfoSummaryCheck(),
            ZoominfoComponentsCheck(),
            ZoominfoHomepageCheck(),
            ZoominfoRobotsCheck(),
        ]
