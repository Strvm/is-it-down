"""Provide functionality for `is_it_down.checkers.services.resend`."""
...
class ResendStatusPageCheck(BaseCheck):
...
class ResendHomepageCheck(BaseCheck):
    """Represent `ResendHomepageCheck`."""

    check_key = "resend_homepage"
    endpoint_key = "https://resend.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ResendDocsCheck(BaseCheck):
    """Represent `ResendDocsCheck`."""

    check_key = "resend_docs"
    endpoint_key = "https://resend.com/docs"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ResendBlogCheck(BaseCheck):
    """Represent `ResendBlogCheck`."""

    check_key = "resend_blog"
    endpoint_key = "https://resend.com/blog"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ResendRobotsCheck(BaseCheck):
    """Represent `ResendRobotsCheck`."""

    check_key = "resend_robots"
    endpoint_key = "https://resend.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class ResendServiceChecker(BaseServiceChecker):
    """Represent `ResendServiceChecker`."""
