"""Provide functionality for `is_it_down.checkers.services.render`."""
...
class RenderStatusPageCheck(BaseCheck):
    """Represent `RenderStatusPageCheck`."""

    check_key = "render_status_page"
    endpoint_key = "https://status.render.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.4
...
class RenderApiAuthCheck(BaseCheck):
    """Represent `RenderApiAuthCheck`."""

    check_key = "render_api_auth"
    endpoint_key = "https://api.render.com/v1/services"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class RenderDashboardCheck(BaseCheck):
    """Represent `RenderDashboardCheck`."""

    check_key = "render_dashboard"
    endpoint_key = "https://dashboard.render.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class RenderServiceChecker(BaseServiceChecker):
    """Represent `RenderServiceChecker`."""

    service_key = "render"
    logo_url = "https://cdn.simpleicons.org/render"
    official_uptime = "https://status.render.com/"
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            RenderStatusPageCheck(),
            RenderApiAuthCheck(),
            RenderDashboardCheck(),
        ]
