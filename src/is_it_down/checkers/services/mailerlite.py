"""Provide functionality for `is_it_down.checkers.services.mailerlite`."""
...
class MailerliteStatusPageCheck(BaseCheck):
    """Represent `MailerliteStatusPageCheck`."""

    check_key = "mailerlite_status_page"
    endpoint_key = "https://status.mailerlite.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class MailerliteHomepageCheck(BaseCheck):
    """Represent `MailerliteHomepageCheck`."""

    check_key = "mailerlite_homepage"
    endpoint_key = "https://www.mailerlite.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class MailerliteDocsCheck(BaseCheck):
    """Represent `MailerliteDocsCheck`."""

    check_key = "mailerlite_docs"
    endpoint_key = "https://developers.mailerlite.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class MailerliteBlogCheck(BaseCheck):
    """Represent `MailerliteBlogCheck`."""

    check_key = "mailerlite_blog"
    endpoint_key = "https://www.mailerlite.com/blog/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class MailerliteRobotsCheck(BaseCheck):
    """Represent `MailerliteRobotsCheck`."""

    check_key = "mailerlite_robots"
    endpoint_key = "https://www.mailerlite.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class MailerliteServiceChecker(BaseServiceChecker):
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            MailerliteStatusPageCheck(),
            MailerliteHomepageCheck(),
            MailerliteDocsCheck(),
            MailerliteBlogCheck(),
            MailerliteRobotsCheck(),
        ]
