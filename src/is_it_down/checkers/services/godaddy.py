"""Provide functionality for `is_it_down.checkers.services.godaddy`."""
...
class GodaddyStatusPageCheck(BaseCheck):
    """Represent `GodaddyStatusPageCheck`."""

    check_key = "godaddy_status_page"
    endpoint_key = "https://status.godaddy.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class GodaddyHomepageCheck(BaseCheck):
    """Represent `GodaddyHomepageCheck`."""

    check_key = "godaddy_homepage"
    endpoint_key = "https://www.godaddy.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class GodaddyDocsCheck(BaseCheck):
    """Represent `GodaddyDocsCheck`."""

    check_key = "godaddy_docs"
    endpoint_key = "https://developer.godaddy.com/doc"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class GodaddyBlogCheck(BaseCheck):
    """Represent `GodaddyBlogCheck`."""

    check_key = "godaddy_blog"
    endpoint_key = "https://www.godaddy.com/resources/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class GodaddyRobotsCheck(BaseCheck):
    """Represent `GodaddyRobotsCheck`."""

    check_key = "godaddy_robots"
    endpoint_key = "https://www.godaddy.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class GodaddyServiceChecker(BaseServiceChecker):
    """Represent `GodaddyServiceChecker`."""

    service_key = "godaddy"
    logo_url = "https://cdn.simpleicons.org/godaddy"
    official_uptime = "https://status.godaddy.com/"
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            GodaddyStatusPageCheck(),
            GodaddyHomepageCheck(),
            GodaddyDocsCheck(),
            GodaddyBlogCheck(),
            GodaddyRobotsCheck(),
        ]
