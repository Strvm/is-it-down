...
class EventbriteStatusCheck(BaseCheck):
    ...
    endpoint_key = "https://status.eventbrite.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class EventbriteSummaryCheck(BaseCheck):
    ...
    endpoint_key = "https://status.eventbrite.com/api/v2/summary.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.2
...
class EventbriteComponentsCheck(BaseCheck):
    ...
    endpoint_key = "https://status.eventbrite.com/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
