"""Provide functionality for `is_it_down.checkers.services.eventbrite`."""
...
class EventbriteStatusCheck(BaseCheck):
    """Represent `EventbriteStatusCheck`."""

    check_key = "eventbrite_status"
    endpoint_key = "https://eventbrite.statuspage.io/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class EventbriteSummaryCheck(BaseCheck):
    """Represent `EventbriteSummaryCheck`."""

    check_key = "eventbrite_summary"
    endpoint_key = "https://eventbrite.statuspage.io/api/v2/summary.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.2
...
class EventbriteComponentsCheck(BaseCheck):
    """Represent `EventbriteComponentsCheck`."""

    check_key = "eventbrite_components"
    endpoint_key = "https://eventbrite.statuspage.io/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class EventbriteHomepageCheck(BaseCheck):
    """Represent `EventbriteHomepageCheck`."""

    check_key = "eventbrite_homepage"
    endpoint_key = "https://www.eventbrite.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class EventbriteRobotsCheck(BaseCheck):
    """Represent `EventbriteRobotsCheck`."""

    check_key = "eventbrite_robots"
    endpoint_key = "https://www.eventbrite.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class EventbriteServiceChecker(BaseServiceChecker):
    ...
    official_uptime = "https://eventbrite.statuspage.io/"
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            EventbriteStatusCheck(),
            EventbriteSummaryCheck(),
            EventbriteComponentsCheck(),
            EventbriteHomepageCheck(),
            EventbriteRobotsCheck(),
        ]
