"""Provide functionality for `is_it_down.checkers.services.framer`."""
...
class FramerStatusCheck(BaseCheck):
    """Represent `FramerStatusCheck`."""

    check_key = "framer_status"
    endpoint_key = "https://status.framer.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class FramerSummaryCheck(BaseCheck):
    """Represent `FramerSummaryCheck`."""

    check_key = "framer_summary"
    endpoint_key = "https://status.framer.com/api/v2/summary.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.2
...
class FramerComponentsCheck(BaseCheck):
    """Represent `FramerComponentsCheck`."""

    check_key = "framer_components"
    endpoint_key = "https://status.framer.com/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class FramerHomepageCheck(BaseCheck):
    """Represent `FramerHomepageCheck`."""

    check_key = "framer_homepage"
    endpoint_key = "https://www.framer.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class FramerRobotsCheck(BaseCheck):
    """Represent `FramerRobotsCheck`."""

    check_key = "framer_robots"
    endpoint_key = "https://www.framer.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class FramerServiceChecker(BaseServiceChecker):
    """Represent `FramerServiceChecker`."""

    service_key = "framer"
    logo_url = "https://cdn.simpleicons.org/framer"
    official_uptime = "https://status.framer.com/"
