"""Provide functionality for `is_it_down.checkers.services.namecheap`."""
...
class NamecheapStatusPageCheck(BaseCheck):
    """Represent `NamecheapStatusPageCheck`."""

    check_key = "namecheap_status_page"
    endpoint_key = "https://www.namecheap.com/status-updates/"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
    ...
    async def run(self, client: httpx.AsyncClient) -> CheckResult:
        ...
        if response.is_success:
            ...
            if payload is None:
                ...
                marker_hits = {
                    "namecheap": "namecheap" in page_text,
...
class NamecheapHomepageCheck(BaseCheck):
    """Represent `NamecheapHomepageCheck`."""

    check_key = "namecheap_homepage"
    endpoint_key = "https://www.namecheap.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class NamecheapDocsCheck(BaseCheck):
    """Represent `NamecheapDocsCheck`."""

    check_key = "namecheap_docs"
    endpoint_key = "https://www.namecheap.com/support/knowledgebase/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class NamecheapBlogCheck(BaseCheck):
    """Represent `NamecheapBlogCheck`."""

    check_key = "namecheap_blog"
    endpoint_key = "https://www.namecheap.com/blog/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class NamecheapRobotsCheck(BaseCheck):
    """Represent `NamecheapRobotsCheck`."""

    check_key = "namecheap_robots"
    endpoint_key = "https://www.namecheap.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class NamecheapServiceChecker(BaseServiceChecker):
    """Represent `NamecheapServiceChecker`."""

    service_key = "namecheap"
    logo_url = "https://cdn.simpleicons.org/namecheap"
    official_uptime = "https://www.namecheap.com/status-updates/"
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            NamecheapStatusPageCheck(),
            NamecheapHomepageCheck(),
            NamecheapDocsCheck(),
            NamecheapBlogCheck(),
            NamecheapRobotsCheck(),
        ]
