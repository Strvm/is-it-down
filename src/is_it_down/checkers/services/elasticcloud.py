"""Provide functionality for `is_it_down.checkers.services.elasticcloud`."""
...
class ElasticcloudStatusCheck(BaseCheck):
    """Represent `ElasticcloudStatusCheck`."""

    check_key = "elasticcloud_status"
...
class ElasticcloudSummaryCheck(BaseCheck):
    """Represent `ElasticcloudSummaryCheck`."""

    check_key = "elasticcloud_summary"
...
class ElasticcloudComponentsCheck(BaseCheck):
    """Represent `ElasticcloudComponentsCheck`."""

    check_key = "elasticcloud_components"
    endpoint_key = "https://status.elastic.co/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ElasticcloudHomepageCheck(BaseCheck):
    """Represent `ElasticcloudHomepageCheck`."""

    check_key = "elasticcloud_homepage"
    endpoint_key = "https://www.elastic.co/cloud/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ElasticcloudRobotsCheck(BaseCheck):
    """Represent `ElasticcloudRobotsCheck`."""

    check_key = "elasticcloud_robots"
    endpoint_key = "https://www.elastic.co/cloud/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class ElasticcloudServiceChecker(BaseServiceChecker):
    """Represent `ElasticcloudServiceChecker`."""

    service_key = "elasticcloud"
    logo_url = "https://cdn.simpleicons.org/elasticcloud"
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            ElasticcloudStatusCheck(),
            ElasticcloudSummaryCheck(),
            ElasticcloudComponentsCheck(),
            ElasticcloudHomepageCheck(),
            ElasticcloudRobotsCheck(),
        ]
