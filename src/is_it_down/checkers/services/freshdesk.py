"""Provide functionality for `is_it_down.checkers.services.freshdesk`."""
...
class FreshdeskStatusPageCheck(BaseCheck):
    """Represent `FreshdeskStatusPageCheck`."""

    check_key = "freshdesk_status_page"
    endpoint_key = "https://updates.freshdesk.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class FreshdeskHomepageCheck(BaseCheck):
    """Represent `FreshdeskHomepageCheck`."""

    check_key = "freshdesk_homepage"
    endpoint_key = "https://www.freshworks.com/freshdesk/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class FreshdeskDocsCheck(BaseCheck):
    """Represent `FreshdeskDocsCheck`."""

    check_key = "freshdesk_docs"
    endpoint_key = "https://developers.freshdesk.com/api/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class FreshdeskBlogCheck(BaseCheck):
    """Represent `FreshdeskBlogCheck`."""

    check_key = "freshdesk_blog"
    endpoint_key = "https://www.freshworks.com/company/blog/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class FreshdeskRobotsCheck(BaseCheck):
    """Represent `FreshdeskRobotsCheck`."""

    check_key = "freshdesk_robots"
    endpoint_key = "https://www.freshworks.com/freshdesk/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class FreshdeskServiceChecker(BaseServiceChecker):
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            FreshdeskStatusPageCheck(),
            FreshdeskHomepageCheck(),
            FreshdeskDocsCheck(),
            FreshdeskBlogCheck(),
            FreshdeskRobotsCheck(),
        ]
