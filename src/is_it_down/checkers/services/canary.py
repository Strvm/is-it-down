"""Provide functionality for `is_it_down.checkers.services.canary`."""
...
class CanaryStatusCheck(BaseCheck):
...
class CanarySummaryCheck(BaseCheck):
...
class CanaryComponentsCheck(BaseCheck):
...
class CanaryHomepageCheck(BaseCheck):
    """Represent `CanaryHomepageCheck`."""

    check_key = "canary_homepage"
    endpoint_key = "https://canarytools.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class CanaryRobotsCheck(BaseCheck):
    """Represent `CanaryRobotsCheck`."""

    check_key = "canary_robots"
    endpoint_key = "https://canarytools.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class CanaryServiceChecker(BaseServiceChecker):
