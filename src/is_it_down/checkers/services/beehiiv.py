"""Provide functionality for `is_it_down.checkers.services.beehiiv`."""
...
class BeehiivStatusPageCheck(BaseCheck):
...
class BeehiivHomepageCheck(BaseCheck):
    """Represent `BeehiivHomepageCheck`."""

    check_key = "beehiiv_homepage"
    endpoint_key = "https://www.beehiiv.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class BeehiivDocsCheck(BaseCheck):
    """Represent `BeehiivDocsCheck`."""

    check_key = "beehiiv_docs"
    endpoint_key = "https://developers.beehiiv.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class BeehiivBlogCheck(BaseCheck):
    """Represent `BeehiivBlogCheck`."""

    check_key = "beehiiv_blog"
    endpoint_key = "https://blog.beehiiv.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class BeehiivRobotsCheck(BaseCheck):
    """Represent `BeehiivRobotsCheck`."""

    check_key = "beehiiv_robots"
    endpoint_key = "https://www.beehiiv.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class BeehiivServiceChecker(BaseServiceChecker):
    """Represent `BeehiivServiceChecker`."""
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            BeehiivStatusPageCheck(),
            BeehiivHomepageCheck(),
            BeehiivDocsCheck(),
            BeehiivBlogCheck(),
            BeehiivRobotsCheck(),
        ]
