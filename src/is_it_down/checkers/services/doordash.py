"""Provide functionality for `is_it_down.checkers.services.doordash`."""
...
class DoordashStatusCheck(BaseCheck):
...
class DoordashSummaryCheck(BaseCheck):
...
class DoordashComponentsCheck(BaseCheck):
...
class DoordashHomepageCheck(BaseCheck):
    """Represent `DoordashHomepageCheck`."""

    check_key = "doordash_homepage"
    endpoint_key = "https://www.doordash.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class DoordashRobotsCheck(BaseCheck):
    """Represent `DoordashRobotsCheck`."""

    check_key = "doordash_robots"
    endpoint_key = "https://www.doordash.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class DoordashServiceChecker(BaseServiceChecker):
    """Represent `DoordashServiceChecker`."""
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        return [
            DoordashStatusCheck(),
            DoordashSummaryCheck(),
            DoordashComponentsCheck(),
            DoordashHomepageCheck(),
            DoordashRobotsCheck(),
        ]
