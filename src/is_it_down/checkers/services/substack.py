"""Provide functionality for `is_it_down.checkers.services.substack`."""
...
class SubstackStatusCheck(BaseCheck):
...
class SubstackSummaryCheck(BaseCheck):
...
class SubstackComponentsCheck(BaseCheck):
...
class SubstackHomepageCheck(BaseCheck):
    """Represent `SubstackHomepageCheck`."""

    check_key = "substack_homepage"
    endpoint_key = "https://substack.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class SubstackRobotsCheck(BaseCheck):
    """Represent `SubstackRobotsCheck`."""

    check_key = "substack_robots"
    endpoint_key = "https://substack.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class SubstackServiceChecker(BaseServiceChecker):
    """Represent `SubstackServiceChecker`."""
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        return [
            SubstackStatusCheck(),
            SubstackSummaryCheck(),
            SubstackComponentsCheck(),
            SubstackHomepageCheck(),
            SubstackRobotsCheck(),
        ]
