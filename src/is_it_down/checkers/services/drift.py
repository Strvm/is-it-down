"""Provide functionality for `is_it_down.checkers.services.drift`."""
...
class DriftStatusPageCheck(BaseCheck):
    """Represent `DriftStatusPageCheck`."""

    check_key = "drift_status_page"
    endpoint_key = "https://status.drift.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class DriftHomepageCheck(BaseCheck):
    """Represent `DriftHomepageCheck`."""

    check_key = "drift_homepage"
    endpoint_key = "https://www.drift.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class DriftDocsCheck(BaseCheck):
    """Represent `DriftDocsCheck`."""

    check_key = "drift_docs"
    endpoint_key = "https://devdocs.drift.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class DriftBlogCheck(BaseCheck):
    """Represent `DriftBlogCheck`."""

    check_key = "drift_blog"
    endpoint_key = "https://www.drift.com/blog/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class DriftRobotsCheck(BaseCheck):
    """Represent `DriftRobotsCheck`."""

    check_key = "drift_robots"
    endpoint_key = "https://www.drift.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class DriftServiceChecker(BaseServiceChecker):
    """Represent `DriftServiceChecker`."""

    service_key = "drift"
    logo_url = "https://cdn.simpleicons.org/drift"
    official_uptime = "https://status.drift.com/"
