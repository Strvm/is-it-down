"""Provide functionality for `is_it_down.checkers.services.zoom`."""
...
class ZoomStatusPageCheck(BaseCheck):
    """Represent `ZoomStatusPageCheck`."""

    check_key = "zoom_status_page"
    endpoint_key = "https://status.zoom.us/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.4
...
class ZoomApiAuthCheck(BaseCheck):
    """Represent `ZoomApiAuthCheck`."""

    check_key = "zoom_api_auth"
    endpoint_key = "https://api.zoom.us/v2/users/me"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class ZoomHomepageCheck(BaseCheck):
    """Represent `ZoomHomepageCheck`."""

    check_key = "zoom_homepage"
    endpoint_key = "https://zoom.us/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class ZoomServiceChecker(BaseServiceChecker):
    """Represent `ZoomServiceChecker`."""

    service_key = "zoom"
    logo_url = "https://cdn.simpleicons.org/zoom"
    official_uptime = "https://status.zoom.us/"
