"""Provide functionality for `is_it_down.checkers.services.hetzner`."""
...
class HetznerStatusPageCheck(BaseCheck):
...
class HetznerHomepageCheck(BaseCheck):
    """Represent `HetznerHomepageCheck`."""

    check_key = "hetzner_homepage"
    endpoint_key = "https://www.hetzner.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class HetznerDocsCheck(BaseCheck):
    """Represent `HetznerDocsCheck`."""

    check_key = "hetzner_docs"
    endpoint_key = "https://docs.hetzner.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class HetznerBlogCheck(BaseCheck):
    """Represent `HetznerBlogCheck`."""

    check_key = "hetzner_blog"
    endpoint_key = "https://www.hetzner.com/newsroom/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class HetznerRobotsCheck(BaseCheck):
...
class HetznerServiceChecker(BaseServiceChecker):
    """Represent `HetznerServiceChecker`."""

    service_key = "hetzner"
    logo_url = "https://cdn.simpleicons.org/hetzner"
    official_uptime = "https://status.hetzner.com/"
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            HetznerStatusPageCheck(),
            HetznerHomepageCheck(),
            HetznerDocsCheck(),
            HetznerBlogCheck(),
            HetznerRobotsCheck(),
        ]
