"""Provide functionality for `is_it_down.checkers.services.deepl`."""
...
class DeeplStatusPageCheck(BaseCheck):
...
class DeeplHomepageCheck(BaseCheck):
    """Represent `DeeplHomepageCheck`."""

    check_key = "deepl_homepage"
    endpoint_key = "https://www.deepl.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class DeeplDocsCheck(BaseCheck):
    """Represent `DeeplDocsCheck`."""

    check_key = "deepl_docs"
    endpoint_key = "https://developers.deepl.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class DeeplBlogCheck(BaseCheck):
    """Represent `DeeplBlogCheck`."""

    check_key = "deepl_blog"
    endpoint_key = "https://www.deepl.com/en/blog/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class DeeplRobotsCheck(BaseCheck):
    """Represent `DeeplRobotsCheck`."""

    check_key = "deepl_robots"
    endpoint_key = "https://www.deepl.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class DeeplServiceChecker(BaseServiceChecker):
    """Represent `DeeplServiceChecker`."""
