"""Provide functionality for `is_it_down.checkers.services.xero`."""
...
class XeroStatusPageCheck(BaseCheck):
    """Represent `XeroStatusPageCheck`."""

    check_key = "xero_status_page"
    endpoint_key = "https://status.developer.xero.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class XeroHomepageCheck(BaseCheck):
    """Represent `XeroHomepageCheck`."""

    check_key = "xero_homepage"
    endpoint_key = "https://www.xero.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class XeroDocsCheck(BaseCheck):
    """Represent `XeroDocsCheck`."""

    check_key = "xero_docs"
    endpoint_key = "https://developer.xero.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class XeroBlogCheck(BaseCheck):
    """Represent `XeroBlogCheck`."""

    check_key = "xero_blog"
    endpoint_key = "https://www.xero.com/blog/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class XeroRobotsCheck(BaseCheck):
    """Represent `XeroRobotsCheck`."""

    check_key = "xero_robots"
    endpoint_key = "https://www.xero.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class XeroServiceChecker(BaseServiceChecker):
    """Represent `XeroServiceChecker`."""

    service_key = "xero"
    logo_url = "https://cdn.simpleicons.org/xero"
    official_uptime = "https://status.developer.xero.com/"
