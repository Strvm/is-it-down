"""Provide functionality for `is_it_down.checkers.services.unity`."""
...
class UnityStatusCheck(BaseCheck):
    """Represent `UnityStatusCheck`."""

    check_key = "unity_status"
    endpoint_key = "https://status.unity.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class UnitySummaryCheck(BaseCheck):
    """Represent `UnitySummaryCheck`."""

    check_key = "unity_summary"
    endpoint_key = "https://status.unity.com/api/v2/summary.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.2
...
class UnityComponentsCheck(BaseCheck):
    """Represent `UnityComponentsCheck`."""

    check_key = "unity_components"
    endpoint_key = "https://status.unity.com/api/v2/components.json"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class UnityHomepageCheck(BaseCheck):
    """Represent `UnityHomepageCheck`."""

    check_key = "unity_homepage"
    endpoint_key = "https://unity.com/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class UnityRobotsCheck(BaseCheck):
    """Represent `UnityRobotsCheck`."""

    check_key = "unity_robots"
    endpoint_key = "https://unity.com/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class UnityServiceChecker(BaseServiceChecker):
    """Represent `UnityServiceChecker`."""

    service_key = "unity"
    logo_url = "https://cdn.simpleicons.org/unity"
    official_uptime = "https://status.unity.com/"
