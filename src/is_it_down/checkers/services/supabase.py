"""Provide functionality for `is_it_down.checkers.services.supabase`."""
...
class SupabaseStatusPageCheck(BaseCheck):
    """Represent `SupabaseStatusPageCheck`."""

    check_key = "supabase_status_page"
    endpoint_key = "https://status.supabase.com/api/v2/status.json"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.4
...
class SupabaseApiAuthCheck(BaseCheck):
    """Represent `SupabaseApiAuthCheck`."""

    check_key = "supabase_api_auth"
    endpoint_key = "https://api.supabase.com/v1/projects"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.35
...
class SupabaseDashboardCheck(BaseCheck):
    """Represent `SupabaseDashboardCheck`."""

    check_key = "supabase_dashboard"
    endpoint_key = "https://supabase.com/dashboard"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class SupabaseServiceChecker(BaseServiceChecker):
    """Represent `SupabaseServiceChecker`."""

    service_key = "supabase"
    logo_url = "https://cdn.simpleicons.org/supabase"
    official_uptime = "https://status.supabase.com/"
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            SupabaseStatusPageCheck(),
            SupabaseApiAuthCheck(),
            SupabaseDashboardCheck(),
        ]
