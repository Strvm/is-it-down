"""Provide functionality for `is_it_down.checkers.services.openstreetmap`."""
...
class OpenstreetmapStatusCheck(BaseCheck):
...
class OpenstreetmapSummaryCheck(BaseCheck):
...
class OpenstreetmapComponentsCheck(BaseCheck):
...
class OpenstreetmapHomepageCheck(BaseCheck):
    """Represent `OpenstreetmapHomepageCheck`."""

    check_key = "openstreetmap_homepage"
    endpoint_key = "https://www.openstreetmap.org/"
    interval_seconds = 60
    timeout_seconds = 5.0
...
class OpenstreetmapRobotsCheck(BaseCheck):
    """Represent `OpenstreetmapRobotsCheck`."""

    check_key = "openstreetmap_robots"
    endpoint_key = "https://www.openstreetmap.org/robots.txt"
    interval_seconds = 60
    timeout_seconds = 5.0
    weight = 0.1
...
class OpenstreetmapServiceChecker(BaseServiceChecker):
    """Represent `OpenstreetmapServiceChecker`."""
    ...
    def build_checks(self) -> Sequence[BaseCheck]:
        ...
        """
        return [
            OpenstreetmapStatusCheck(),
            OpenstreetmapSummaryCheck(),
            OpenstreetmapComponentsCheck(),
            OpenstreetmapHomepageCheck(),
            OpenstreetmapRobotsCheck(),
        ]
